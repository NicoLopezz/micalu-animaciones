      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold mb-4 text-gray-800">Jugadores Conectados</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4 text-gray-800">Estado del Juego</h3>
              ...
              {currentRoom.status === 'waiting' && (
                <button 
                  ...
                  className="w-full bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600 disabled:opacity-50 disabled:bg-gray-400 transition-colors font-medium"
                >
                  {isLoading ? 'Iniciando...' : 
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800 placeholder-gray-500"
                rows={3}
                ...
                {newQuestion.options.map((option, index) => (
                  <div key={index} className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800 placeholder-gray-500"
